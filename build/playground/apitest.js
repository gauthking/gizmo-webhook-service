...
const caller = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userAddress = "0xa5d0D51671645b1509A29bDD4A282940a6dE8E76";
        ...
        const data = yield alchemy.core.getTransactionReceipt("0xa3d987ed4e9ef4349dfefe2760e8400ceefb30586ca123d4b9646e5d4e0ff555");
        console.log(data);
